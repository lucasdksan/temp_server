...
INSERT INTO "new_modificationRecord" ("created_at", "id", "last_change", "update_at", "user_id") SELECT "created_at", "id", "last_change", "update_at", "user_id" FROM "modificationRecord";
